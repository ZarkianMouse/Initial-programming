...
#ifndef LABFUNCTIONS_H_INCLUDED
#define LABFUNCTIONS_H_INCLUDED
...
/* Process Choices */ // excludes display option
// adds new user/student to computer lab list
void loginStudent(LabList []);
// removes user/student from list
void logoffStudent(LabList []);
